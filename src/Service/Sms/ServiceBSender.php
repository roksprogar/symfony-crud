...
class ServiceBSender implements SmsSenderInterface
{
    private const MAX_PER_MINUTE = 5;
    private const CACHE_KEY = 'sms_b_rate_limit_';
    ...
    public function sendSms(string $to, string $content): bool
    {
        if (!$this->canSend()) {
            ...
            throw new SmsRateLimitsExceededException('Service B rate limit exceeded.');
        }
